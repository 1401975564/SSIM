...
#         we recommend using vit_tiny or vit_small.""")
    ...
    parser.add_argument('--output_dir', default="./train-mae-test-1", type=str, help='Path to save logs and checkpoints.')
...
class DataAugmentationDINO(object):
    def __init__(self, global_crops_scale, local_crops_scale, local_crops_number,bin_path,save_path):
